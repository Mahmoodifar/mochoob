<aside id="sidebar" class="sidebar">
    <section class="sidebar-container">
        <section class="sidebar-wrapper">
            ...
            <a href="{{ route('customer.home') }}" class="sidebar-link" target="blank">
            ...
            <a href="{{ route('admin.user.customer.index') }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
                <span>مشتریان</span>
            </a><section class="sidebar-group-link">
                <section class="sidebar-dropdown-toggle">
                    <i class="fas fa-chart-bar icon"></i>
                ...
                <section class="sidebar-dropdown">
                    <a href="{{ route('admin.user.permission.index') }}">مدیریت دسترسی ها ها </a>
