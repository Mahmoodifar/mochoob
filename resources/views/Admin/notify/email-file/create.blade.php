...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12"><a href="{{ route('admin.notify.email-file.index',$email->id) }}">فایل اطلاعیه ایمیلی</a>
            </li>
                            ...
                            <section class="col-12 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="path" id="path" class="form-control form-control-sm">
                                        <option value="0" @if (old('path') == 0) selected @endif>Public
                                        </option>
                                        <option value="1" @if (old('path') == 1) selected @endif>Storage
                                        </option>
                                    </select>
                                </div>
                                @error('path')
