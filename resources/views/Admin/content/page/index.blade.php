        ...
        <section class="col-12">
            <section class="main-body-container ">
                ...
                <section class=" border-bottom pb-2 d-flex justify-content-between align-aitems-center mt-4 mb-3 ">
                    <a href="{{ route('admin.content.page.create') }}" class="btn btn-info btn-sm">ایجاد پیچ جدید</a>
                            ...
                            @foreach ($pages as $key => $page)
                                <tr>
                                    ...
                                    <td class="width-16-rem text-left">
                                        ...
                                        <form action="{{ route('admin.content.page.destroy', $page->id) }}" class="d-inline"
                                            method="POST">
                                            @csrf
                                            {{ method_field('delete') }}
                ...
                success: function(response)
                    ...
                    if (response.status)
                    {
                        if(response.checked)
                        {
                            ...
                            successToast(' پیج شما با موفقیت فعال شد');
                        }
                        else
                        {
                             element.prop('checked',false);
                             successToast('پیج شما با موفقیت غیر فعال شد');
                        }
                    }
                    else
                        {
