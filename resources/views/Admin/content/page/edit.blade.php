...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12"><a href="{{ route('admin.content.page.index') }}">پیج ساز</a>
            </li>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container ">
                ...
                <section>
                    <form action="{{ route('admin.content.page.update',$page->id) }}" id="form" method="POST">
                        @csrf
                        {{method_field('PUT')}}
                        <section class="row d-flex justify-content-between">
                            <section class="col-12 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="title" name="title" id="title" value="{{ old('title',$page->title) }}"
