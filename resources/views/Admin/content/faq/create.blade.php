                        ...
                        <section class="row d-flex justify-content-between">
                            ...
                            <section class="col-12">
                                <div class="form-group ">
                                    ...
                                    <input type="text" id="question" name="question" class="form-control form-control-sm">
                                </div>
                                @error('question')
                            ...
                            <section class="col-12">
                                <div class="form-group ">
                                    ...
                                    <textarea name="asnwer" id="answer" rows="6" class="form-control form-control-sm"></textarea>
                                </div>
                                @error('answer')
                                <span class="alert_required bg-danger rounded text-white p-1" role="alert">
                                    <strong>
