...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12"><a href="{{ route('admin.ticket.category.index') }}"> کاربر ادمین</a>
            </li>
                        ...
                        <section class="row d-flex justify-content-between">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="name" value="{{old('name',$ticketCategory->name)}}" class="form-control form-control-sm">
                                </div>
                                @error('name')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control form-control-sm">
                                        <option value="0" @if (old('status',$ticketCategory->status) == 0) selected @endif>غیرفعال
                                        </option>
