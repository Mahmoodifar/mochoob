                        ...
                        <section class="row d-flex justify-content-between">
                            <section class="col-12 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="persian_name" value="{{ old('persian_name') }}" id="persian_name" class="form-control form-control-sm">
                                </div>
                                @error('persian_name')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="original_name" value="{{ old('original_name') }}" id="original_name" class="form-control form-control-sm">
                                </div>
                                @error('original_name')
                                    <span class="alert_required bg-danger rounded text-white p-1" role="alert">
                                        <strong>
