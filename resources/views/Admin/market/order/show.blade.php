...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> فاکتور سفارشات</li>
        </ol>
    </nav>
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover" id="printable">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th class="max-whidth-16-rem text-left"><i class="fa fa-cogs"></i> تنظیمات</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="border-bottom">
                                <th>تاریخ ارسال</th>
                                <td class=" text-left font-weight-bolder">
                                    {{  jalaliDate($order->delivery_date, '%A, %d %B %y ساعت :  H:i:s') ?? '-' }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                            ...
                            <tr class="border-bottom">
                                <th>مبلغ تخفیف همه محصلات</th>
                                <td class=" text-left font-weight-bolder">
                                    {{ $order->order_total_product_discount_amount . ' تومان ' ?? '-' }}
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <th>مبلغ نهایی</th>
