                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th class="text-center">نام گارانتی</td>
                        ...
                        <tbody>
                            @foreach ($product->guarantees as $guarantee)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $guarantee->price_increase }}</td>
                                    <td class="text-center">{{ $product->name }}</td>
                                    <td class="whidth-8-rem text-left">
                                        <a href="{{ route('admin.market.guarantee.edit', ['product' => $product->id, 'guarantee' => $guarantee->id]) }}"
