    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container ">
                ...
                <section>
                    <form action="{{ route('admin.market.product.update', $product->id) }}" id="form"
                                    ...
                                    <select name="brand_id" id="brand_id" class="form-control form-control-sm">
                                        ...
                                        @foreach ($productBrands as $productBrand)
                                            <option value="{{ $productBrand->id }}"
                                                @if (old('brand_id', $product->brand_id) == $productBrand->id) selected @endif>
                                                {{ $productBrand->original_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="weight" id="weight"
                                        value="{{ old('weight', $product->weight) }}" class="form-control form-control-sm">
                                </div>
                                @error('weight')
                                    <span class="alert_required bg-danger rounded text-white p-1" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="height" id=""
                                        value="{{ old('height', $product->height) }}" class="form-control form-control-sm">
                                </div>
                                @error('height')
                                    <span class="alert_required bg-danger rounded text-white p-1" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="width" id="width"
                                        value="{{ old('width', $product->width) }}" class="form-control form-control-sm">
                                </div>
                                @error('width')
                                    <span class="alert_required bg-danger rounded text-white p-1" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="length" id="length"
                                        value="{{ old('length', $product->length) }}" class="form-control form-control-sm">
                                </div>
                                @error('length')
                                    <span class="alert_required bg-danger rounded text-white p-1" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="price" id="price"
                                        value="{{ old('price', $product->price) }}" class="form-control form-control-sm">
                                </div>
                                @error('price')
                                    <span class="alert_required bg-danger rounded text-white p-1" role="alert">
                                        <strong>
                            ...
                            <section class="col-12 my-2">
                                <div class="form-group ">
                                    ...
                                    <input type="hidden" id="tags" name="tags"
                                        class="form-control form-control-sm" value="{{ old('tags', $product->tags) }}">
