...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12"><a href="{{ route('admin.market.gallery.index',$product->id) }}"> عکس های کالا </a>
            </li>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container ">
                ...
                <section>
                    <form action="{{ route('admin.market.gallery.store',$product->id) }}" enctype="multipart/form-data" method="POST">
                        @csrf
