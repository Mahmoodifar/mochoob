...
@section('head-tag')
    <title>ایجاد ویژگی فرم کالا</title>
@endsection
...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد ویژگی فرم کالا</li>
        </ol>
    </nav>
                        ...
                        <section class="row d-flex justify-content-between">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="value" id="value" name="value" class="form-control form-control-sm"
                                        value="{{ old('value') }}">
                                </div>
                                @error('value')
                                    <span class="alert_required bg-danger rounded text-white p-1" role="alert">
