                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9 mb-3">
                            <form action="" id="cart-item" method="post" id="cart_items"
                                ...
                                <p><i class="fa fa-store-alt cart-product-selected-store me-1"></i> <span>کالا
                                        ...
                                        در انبار</span></p>
                                <section>
                                    <section class="cart-number d-inline-block ">
                                        <button class="cart-number-down" type="button">-</button>
                                        <input class="number" name="number[{{$cartItem->id}}]" data-product-price="{{ $cartItem->cartItemProductPrice() }}"
                        ...
                        <section class="align-self-end flex-shrink-1">
                            @if (!empty($cartItem->product->activeAmazingSales()))
                                ...
                                <section class="text-nowrap fw-bold">{{ priceFormat($cartItem->cartItemProductPrice()) }}
                                    تومان</section>
                            @else
                                <section class="text-nowrap fw-bold">{{ priceFormat($cartItem->cartItemProductPrice()) }}
                                    تومان</section>
                ...
                <section class="col-md-3">
                    <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                        ...
                        <section class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="text-danger fw-bolder" id="total_discount">{{ priceFormat($totalDiscountPrice) }}
                                تومان</p>
                        </section>
                        ...
                        <section class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="fw-bolder" id="total_price">
                                {{ priceFormat($totalProductPrice - $totalDiscountPrice) }} تومان</p>
                        </section>
                        ...
                        <section class="">
                            <button onclick="document.getElementById('cart-item').submit();"
                                                ...
                                                <a class="product-link"
                                                    ...
                                                    <section class="product-image">
                                                        <img class=""
                                                            ...
                                                            alt="{{ $relatedProduct->image['indexArray']['medium'] }}">
                                                    </section>
