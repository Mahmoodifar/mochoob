                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="d-flex justify-content-center my-4">
                            ...
                            <a class="btn btn-primary btn-sm mx-1"
                                href="{{ route('customer.profile.orders', 'type=1') }}">در
                                انتظار تایید</a>
                            ...
                            <a class="btn btn-dark btn-sm mx-1" href="{{ route('customer.profile.orders', 'type=4') }}">باطل
                                شده</a>
                                    ...
                                    <section class="d-flex justify-content-between">
                                        <section>
                                            <section class="order-item-date"><i
                                                    class="fa fa-calendar-alt"></i>{{ jalaliDate($order->created_at, '%A, %d %B %y ساعت :  H:i:s') }}
                                            </section>
                                            <section class="order-item-id"><i class="fa fa-id-card-alt"></i>
                                                {{ $order->id }}
                                            </section>
                                            <section class="order-item-status"><i
                                                    class="fa fa-clock"></i>{{ $order->getPaymentStatusValueAttribute() }}
                                            </section>
                                            <section class="order-item-products">

                                                @forelse (auth()->user()->products as $product)
                                                    <a href="{{ route('customer.market.product', $product) }}"><img
