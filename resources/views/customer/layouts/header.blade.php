        ...
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                ...
                <section class="mt-3 mt-md-auto search-wrapper">
                    <section class="search-box">
                        <section class="search-textbox">
                            ...
                            <form action="{{route('customer.products',[ 'category' => request()->category ? request()->category->id : null,'search' => request()->search, 'sort' => request()->sort, 'min_price' => request()->min_price, 'max_price' => request()->max_price, 'brands' => request()->brands])}}" method="get">
                ...
                <section class="mt-3 mt-md-auto text-end">
                    ...
                    @guest
                        <a href="{{ route('auth.customer.login-register') }}"
                            class="btn btn-lind text-decoration-none text-dark profile-button">
                    ...
                    @auth
                        ...
                        <section class="header-cart d-inline ps-3 border-start position-relative">
                            ...
                            <section class="header-cart-dropdown">
                                <section class="border-bottom d-flex justify-content-between p-2">
                                    <span class="text-muted">{{$cartItems->count()}}</span>
                                        ...
                                        <a class="text-decoration-none text-dark"
                                            ...
                                            <section
                                                ...
                                                <img class="flex-shrink-1"
                                                    ...
                                                    alt="{{ $cartItem->product->image['indexArray']['small'] }}">
                                                <section class="w-100 text-truncate">{{ $cartItem->product->name }}
                                        </a>
                                </section>
                                <section class="flex-shrink-1"><a class="text-muted text-decoration-none p-1"
                                        href="{{ route('customer.sales-process.remove-from-cart', $cartItem) }}"><i
                                            class="fa fa-trash-alt"></i></section>
                            </section>
                            </a>
                            @endforeach
                        </section>
                        <section
                            ...
                            <section class="">
                                ...
                                <section> {{ priceFormat($totalProductPrice - $totalDiscountPrice) }} تومان</section>
                            </section>
                ...
                <section class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                    ...
                    <section class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel"><a class="text-decoration-none"
                                href="{{route('customer.home')}}"><img src="assets/images/logo/8.png" alt="logo"></a></h5>
