...
<section class="content-wrapper bg-white p-3 rounded-2 mb-3">
    <form
        action="{{ route('customer.products', ['category' => request()->category ? request()->category->id : null, 'search' => request()->search, 'sort' => request()->sort, 'min_price' => request()->min_price, 'max_price' => request()->max_price, 'brands' => request()->brands]) }}"
        method="get">
        <section class="content-wrapper bg-white p-3 rounded-2 mb-3">
            <!-- start sidebar nav-->
        ...
        <section class="text-center">
            <a class="btn btn-warning w-100" href="{{route('customer.products')}}">حذف فیلتر ها</a>
        </section>
    </form>
</section>
</aside>
