        ...
        <section class="row">
            ...
            <section class="col-md-4 ps-1">
                @foreach ($topBanners as $topBanner)
                    <section class="mb-2">
                        <a href="{{ urldecode($topBanner->url) }}" class="d-block"><img class="w-100 rounded-2"
                                src="{{ asset($topBanner->image) }}" alt="{{ $topBanner->title }}"></a>
                    </section>
                @endforeach
            </section>
        </section>
                                            ...
                                            <section class="product">
                                                ...
                                                <a class="product-link"
                                                    ...
                                                    <section class="product-image">
                                                        <img class=""
                                                            src="{{ $mostVisitedProduct->image['indexArray']['medium'] }}"
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link"
                                                    ...
                                                    <section class="product-image">
                                                        <img class=""
                                                            src="{{ $offerProduct->image['indexArray']['medium'] }}"
                                                            alt="{{ $offerProduct->name }}">
                                                    </section>
                                                    <section class="product-colors"></section>
                                                    <section class="product-name">
                                                        <h3>{{ Str::Limit($offerProduct->name, 15) }}</h3>
                                                    </section>
                                                    <section class="product-price-wrapper">
                                                        <section class="product-discount">
                                                            {{-- <span class="product-old-price"></span>
                            ...
                            @foreach ($brands as $brand)
                                <section class="item">
                                    <section class="brand-item">
                                        <a href="{{ urldecode($brand->url) }}"><img class="rounded-2"
