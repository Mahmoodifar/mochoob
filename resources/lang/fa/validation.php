...
return [
    ...
    */
    'attributes' => [
        ...
        'price_increase'            => 'مبلغ اضافه شده',
        'value'                     => 'مقدار',
        'product_id'                => 'کالا',
        'reception'                 => 'نام تحویل گیرنده',
        'deliver'                   => 'نام تحویل دهنده',
        'marketable_number'         => 'تعداد قابل فروش',
        'percentage'                => 'درصد',
        'discount_ceiling'          => 'سقف تخفیف',
        'minimal_order_amount'      => 'حداقل سفارش',
        'start_date'                => 'تاریخ شروع',
        'end_date'                  => 'تاریخ پایان',
        'code'                      => 'کد تخفیف',
        'user_id'                   => 'کاربر',
        'type'                      => 'نوع کاربر',
        'id'                        => 'شماره تلفن و یا ایمیل شما',
        'otp'                       => 'کد احراز هویت',
