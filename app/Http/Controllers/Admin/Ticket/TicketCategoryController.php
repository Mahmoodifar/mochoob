...
class TicketCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.ticket.ticket-category.index', compact('categories'));
    }
    ...
    public function store(TicketCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.ticket.category.index')->with('swal-success', ' دسته بندی تیکت شما با موفقیت ایجاد شد');
    }
    ...
    public function update(TicketCategoryRequest $request, TicketCategory $ticketCategory)
    {
        ...
        return redirect()->route('admin.ticket.category.index')->with('swal-success', ' دسته بندی شما با موفقیت اپدیت شد');
    }
