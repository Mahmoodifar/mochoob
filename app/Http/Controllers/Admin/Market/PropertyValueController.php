...
class PropertyValueController extends Controller
{
    ...
    public function store(CategoryValueRequest $request, CategoryAttribute $categoryAttribute)
    {
        ...
        return redirect()->route('admin.market.value.index', $categoryAttribute->id)->with('swal-success', 'فرم ویژگی های شما با موفقیت ایجاد شد');
    }
    ...
    public function update(CategoryValueRequest $request, CategoryAttribute $categoryAttribute, CategoryValue $value)
    {
        ...
        return redirect()->route('admin.market.value.index', $categoryAttribute->id)->with('swal-success', 'فرم ویژگی های شما با موفقیت ویرایش شد');
    }
    ...
    {
        $result = $value->delete();
        return redirect()->route('admin.market.value.index',$categoryAttribute->id)->with('swal-success', ' فرم ویژگی های شما با موفقیت حذف شد');
    }
}
