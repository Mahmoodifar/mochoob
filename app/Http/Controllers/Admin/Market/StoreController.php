...
class StoreController extends Controller
{
    ...
    public function store(StoreRequest $request,Product $product)
    {
        ...
        Log::info("receiver => {$request->receiver}, deliverer => {$request->deliverer}, descriptiondescription}, add => {$request->marketable_number} ");

        return redirect()->route('admin.market.store.index')->with('swal-success', ' انبار شما با موفقیت اپدیت شد');
    ...
    public function update(StoreRequest $request, Product $product)
    {
        ...
        return redirect()->route('admin.market.store.index')->with('swal-success', ' انبار شما با موفقیت بروزرسانی شد');
