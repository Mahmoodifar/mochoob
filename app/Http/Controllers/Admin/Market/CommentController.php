...
class CommentController extends Controller
{
    ...
    {
        $commentUnseens = Comment::where('commentable_type', 'App\Models\Market\Product')->where('seen',0)->get();
    ...
    public function approved(Comment $comment)
    {
        ...
        if ($result) {
            ...
            return redirect()->route('admin.market.comment.index')->with('swal-success', ' وضعیت نظر شما با موفقیت اپدیت شد');
        } else {
            return redirect()->route('admin.market.comment.index')->with('swal-success', ' وضعیت نظر شما با خطا مواجه شد');
        }
    }
    ...
    public function answer(CommentRequest $request, Comment $comment)
    {
        if ($comment->parent_id == null) {
            ...
            return redirect()->route('admin.market.comment.index')->with('swal-success', ' با خطا مواجه شدید');
        }
    }
}
